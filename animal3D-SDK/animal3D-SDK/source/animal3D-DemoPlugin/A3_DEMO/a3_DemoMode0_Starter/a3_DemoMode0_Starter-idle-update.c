...
void a3starter_update(a3_DemoState* demoState, a3_DemoMode0_Starter* demoMode, a3f64 const dt)
{
	...
	y0 = currentClip->keyframePool->keyframe[currentKeyframeIndex].val_y;
	z0 = currentClip->keyframePool->keyframe[currentKeyframeIndex].val_z;
	x0 = currentClip->keyframePool->keyframe[currentKeyframeIndex].val_x;

	y1 = nextClip->keyframePool->keyframe[nextKeyframeIndex].val_y;
	z1 = nextClip->keyframePool->keyframe[nextKeyframeIndex].val_z;
	x1 = nextClip->keyframePool->keyframe[nextKeyframeIndex].val_x;
